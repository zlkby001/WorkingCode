...
public class register1servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!password1.equals(password2)){
			...
			int i=as.register1(password1, name, usertype, endtype, address, phonenum, email,gender,certclass,certnumber);
			if(i==1){
				...
				request.getRequestDispatcher("../register1success.jsp").forward(request,response);
				return;
			}
		}
		request.getRequestDispatcher("../register1result.jsp").forward(request,response);
	}
