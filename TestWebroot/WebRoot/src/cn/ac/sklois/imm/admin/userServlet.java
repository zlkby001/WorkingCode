...
public class userServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList c=ms.ListAllUsers(ip,username,pubkey);	
		request.getSession(true).setAttribute("c",c);
		getServletContext().getRequestDispatcher("/UserList.jsp?p=1").forward(request,response);
	}
