...
public class modifyCertServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public modifyCertServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String certclass=(String)request.getParameter("certclass");
		...
		int i=as.modifyCert(OperatorID, certclass,certnumber);
