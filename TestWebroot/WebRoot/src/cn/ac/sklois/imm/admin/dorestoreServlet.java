...
public class dorestoreServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public dorestoreServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int olduserid=Integer.parseInt(request.getParameter("newuserid"));
		boolean b;
		AdminService as=new AdminService();
		b=as.dorestore(newuserid,olduserid);
		JSONObject result=new JSONObject();
		if(b){
			result.put("success", "true");
//			request.setAttribute("result","É¾³ýÓÃ»§³É¹¦!");
		}
		else{
			result.put("errorMsg", "ÐÞ¸´Ê§°Ü");
//			request.setAttribute("result","É¾³ýÓÃ»§Ê§°Ü!");
		}
		try {
