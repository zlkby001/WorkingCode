...
public class gethistoryintoknowledgeServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public gethistoryintoknowledgeServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getSession(true).setAttribute("kname", kname);
		...
		*/
		request.getRequestDispatcher("../historyintoknowledgeframe.jsp").forward(request,response);
