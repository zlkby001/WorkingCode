...
public class adllAllPagesHistoryServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public adllAllPagesHistoryServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		MappingService ms=new MappingService();
		boolean result=ms.DumpHistoryToWhite(hsearch,Integer.parseInt(user.getID()));
		int userid = Integer.parseInt(user.getID());
		
		if(result){
			  audit.log_record(userid, loginservlet.usertype, loginservlet.name1, "导入白名单", "远程日志全部信任导入完成");
