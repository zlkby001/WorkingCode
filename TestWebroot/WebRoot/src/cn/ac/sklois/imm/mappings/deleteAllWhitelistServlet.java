...
public class deleteAllWhitelistServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public deleteAllWhitelistServlet() {
		super();
	}
...
//				fb.setSoftwareName("锟斤拷锟斤拷锟�);
		...
		if(result){
			...
			audit.log_record(id, loginservlet.usertype, loginservlet.name1, "删除白名单", "白名单-选中删除完成");
