<%@ page language="java" contentType="text/html; charset=GBK"
   ...
   <%@ page import="java.util.ArrayList,java.util.Iterator,cn.ac.sklois.imm.mappings.*,com.jspSmartUpload.upload.*,java.text.SimpleDateFormat,java.util.Date;"  %> %>
...
<form name="fr" action="servlet/uploadFileServlet" method="post" enctype="multipart/form-data" onsubmit="return checkForm(this);">
  <table style="border-collapse: collapse;" align="center" border="0" bordercolor="#77aa33" cellpadding="2" cellspacing="4" width="100%">
		       ...
		       <%
		        ...
		        <tr>
		        	...
		        	<td style="padding-left: 2px;">
		        		<input type="text" name="sissuetime" value=<%=sissuetime%> > 
		        	</td>
		        </tr>
