...
<script type="text/javascript">
	...
	Ext.onReady(function(){
		...
		var gdAlertDetail = new Ext.grid.GridPanel({
		   ...
		   handler:function(){doSearch();}
			...
			{
				id : 'desc', // id assigned so we can apply custom css (e.g. .x-grid-col-topic b { color:#333 })
				header : "备注信息",
				dataIndex : 'des',
				hidden:false
				//width: 50,
    ...
    var tb1=new Ext.Toolbar({
       ...
       items:[       
		  ...
		  // handler:function(){addKnowledge();}
		   handler:function(){window.location.href="showaddKnowledge.jsp";}
    ...
    function doSearch(){
    	...
    	var ver = Ext.getCmp('vers').getValue();
    	var des = Ext.getCmp('des').getValue();
    	//alert(os);
    	store.load({params:{start:0,limit:20,name:name,os:os,ver:ver,des:des}}); 
