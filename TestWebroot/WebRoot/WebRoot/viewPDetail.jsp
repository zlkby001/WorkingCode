...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <table style="border-collapse: collapse;" align="center" border="0" bordercolor="#77aa33" cellpadding="2" cellspacing="4" width="90%">
		        ...
		        <!--end  -->
		         ...
		         <tr>
		        	<td style="padding-left: 10px;" width="20%">用户类别:</td>
		        	<td style="padding-left: 2px;">
		        	<%  String temp=a.getUsertype();
		        	if(temp.equalsIgnoreCase("super")){
		        		out.println("客户端超级用户");
		        		}
		        		...
		        		out.println("客户端普通用户");
		        			...
		        			out.println("服务端管理员");
		        		}else if(temp.equalsIgnoreCase("supermanager")){
		        		 	out.println("服务端超级管理员");
		        		 	}
		        	%></td>
		        </tr>
		        <tr> 
                ...
                <td height="20"></td>
   					   			...
   					   			<%String flag=(String)request.getParameter("flag");
   					   				...
   					   				if(flag.equalsIgnoreCase("unpass")){
   					   					out.print("<a href='listUnPassAdminsServlet'>返回列表</a>");
   					   				}else{
   					   					out.print("<a href='listAdminsServlet'>返回列表</a>");
   					   				}
