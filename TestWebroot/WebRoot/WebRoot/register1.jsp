...
<html>
<head>
<title>平台身份管理系统 | 用户注册/User Register1</title>
...
<div id=page>
  ...
  <form method="post" action="servlet/register1servlet"  onsubmit="return VerifyInput()">
              ...
              <td align=center bgcolor="#FFFFFF"><table border=0 cellpadding=0 cellspacing=0 width=100%>
                ...
                <table width=100% height="500px" border=0 cellpadding=0 cellspacing=1 bgcolor="#CCCCCC">
                  <tr>
                   ...
                   <tr>
                    <td height="28" align=left bgcolor="#FFFFFF">&nbsp;用户类型:</td>
                    <td align=left bgcolor="#FFFFFF">&nbsp;
