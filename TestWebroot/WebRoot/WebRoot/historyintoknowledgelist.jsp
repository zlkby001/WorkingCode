<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.ArrayList,java.util.Iterator,cn.ac.sklois.imm.mappings.*,cn.ac.sklois.imm.admin.*"%>
...
return true;
	...
	function doSubmit() {
  	...
  	document.forms[0].action = "servlet/addmultipleknowledgesServlet";
					...
					<tr>
								...
								<table id="tbHistory" width=100%>
									...
									<thead>
										<tr>
											...
											<th field="f04" width="100px" align="center">信任状态
											</td>
										...
										<%
											...
											if (al != null) {
												...
												while ((i + (currentpage - 1) * 20) < al.size() && i < 20) {
													...
													out.println("[<a href='servlet/addmultipleknowledgeServlet?aid="
						...
						<table style= "font-size:12px">
									<tr>
										...
										<td align=center>
											<%
												String url ="historyintoknowledgelist.jsp";
