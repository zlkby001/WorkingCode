...
<script type="text/javascript">
    ...
    function renderOperate(value, p, record){
    	//var html = "<a href='javascript:void(0)' onclick='deleteUser()'>[删除]</a>&nbsp;&nbsp;<a href='javascript:void(0)' onclick='scanWhithList()'>[白名单]</a>" 
    				 //+ "&nbsp;&nbsp;<a href='javascript:void(0)' onclick='scanHistory()'>[历史记录]</a>" ;
    	var html = "<a href=wlsnapshotindex.jsp?oid=" + record.data.id + ">[详情]</a> ";
        return html;
    }
    ...
    function wl(){
		...
		if (navigator.userAgent.indexOf('MSIE 6.0')>0) {	//判断是否IE浏览器
			location.href='./wlsnapshotindex.jsp?oid=' + r.data.id;
	    }
		else
			self.location='wlsnapshotindex.jsp?oid=' + r.data.id;
