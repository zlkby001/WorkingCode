...
function checkForm(form){
	...
	//}
     	...
     	var val = confirm("您确定要导入此知识库文件吗??");
		if (val) {
		  var ics_id=<%=ics_id%> 
		     
		   document.forms[0].action= "servlet/uploadknowledgefromxmlServlet?ics_id="+ics_id; 
     	   document.forms[0].submit();
...
color: #000022;
   ...
   <form name="fr" id="form1" action="" method="post" enctype="multipart/form-data" onsubmit="return checkForm(this);">
