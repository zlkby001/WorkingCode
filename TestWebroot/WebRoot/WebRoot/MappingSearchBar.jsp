...
<FORM action=servlet/historyServlet id="form1" name="form1" method=get target=attbottom >


<TABLE height="50px">
  <TBODY>
  <TR>
    <TD >软件类型：<br><SELECT name="sclass"> 
    ...
    <!-- <TD >软件名称(支持模糊查找)<br><INPUT type="text" name="softwareName"  size="10"> </TD> -->
    <TD >文件名<br><INPUT type="text" name="sname"  size="10"> </TD>
    <TD >验证日期<br><INPUT type="text" name="sdate"  size="10"> </TD>
    
    <TD >信任状态：<br><SELECT name="avalue"> 
...
function doSubmit() {
    document.getElementById('form1').action = "servlet/historyServlet";
