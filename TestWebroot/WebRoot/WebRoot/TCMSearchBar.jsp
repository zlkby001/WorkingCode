...
<FORM action=servlet/TCMServlet name="form1" method=get target=attbottom1 >


<TABLE width="65%">
  <TBODY>
  <TR>
    <TD >终端IP地址(支持模糊查找)<br><INPUT type="text" name="ip" size="20"> </TD>
    <TD >用户名(支持模糊查找)<br><INPUT type="text" name="username" size="20"> </TD>
    <TD >用户公钥(支持模糊查找)<br><INPUT type="text" name="pubkey" size="20"> </TD>
    <TD >EK公钥(支持模糊查找)<br><INPUT type="text" name="EK" size="20"> </TD>
