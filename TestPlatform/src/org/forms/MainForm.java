...
//	JUpdateComposite cs7;
	...
	public void timeToLogUpload(){  
		timer_logUpload = new Timer(); 
		timerToLogUpload LogUpload = new timerToLogUpload();
		timer_logUpload.schedule(LogUpload, 10*1000, 10*1000);  
		System.out.println("timer_logupload:");
    }  
					...
					if (!utilit.IPisCorrect(ip)) {
						...
						//	System.out.println("download:"+uicontent);
							...
							for(int i=0; i<temp.length; i++) {
								...
								//System.out.println("name: "+temps[0]+"password: "+temps[1]+"usertpye: "+temps[2]);
...
//		shell.setBackground(new Color(display,255,255,100));
		...
		final ToolItem tim7 = new ToolItem(toolBar, SWT.PUSH);
		tim7.setImage(SWTResourceManager.getImage(imagePath + "toolbox1.png"));
		tim7.setHotImage(SWTResourceManager.getImage(imagePath + "toolbox3.png"));
		...
		cs6 = proSet;
		ToolBox toolbox = new ToolBox(shell,0);
		cs7=toolbox;
...
//       		}
        ...
        Listener lis7 = new Listener() {  //显示7号页面
            public void handleEvent(Event event) {            	
...
//       		}
       ...
       // tim4.addListener(SWT.Selection, lis4);
        ...
        tim7.addListener(SWT.Selection, lis7);
        ...
        cs7.addMouseListener(mouseListener);
       ...
       // cs4.addMouseMoveListener(mouseMoveListener);
        ...
        cs7.addMouseMoveListener(mouseMoveListener);
